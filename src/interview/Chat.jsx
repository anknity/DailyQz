...
/**
 * ChatPanel — Side panel / full-screen overlay for room-based real-time messaging
 */
const ChatPanel = ({ roomId, isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 sm:static sm:inset-auto w-full h-full sm:w-80 bg-[#1a1a2e] sm:border-l border-gray-700/50 flex flex-col sm:h-full flex-shrink-0 z-40 sm:z-auto">
        {/* Header */}
        ...
        {/* Input */}
        <form onSubmit={sendMessage} className="p-3 border-t border-gray-700/50 flex-shrink-0" style={{ paddingBottom: 'max(12px, env(safe-area-inset-bottom))' }}>
